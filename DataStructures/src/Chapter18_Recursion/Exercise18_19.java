...
public class Exercise18_19 extends Application {
  ...
  public void start(Stage primaryStage) {       
    ...
    btnMinus.setOnAction(e -> trianglePane.setOrder(trianglePane.order - 1));
    btnPlus.setOnAction(e -> trianglePane.setOrder(trianglePane.order + 1));

    // Pane to hold label and buttons
    HBox hBox = new HBox(10);
    hBox.getChildren().addAll(new Label("Increase or decrease the order: "), btnMinus, btnPlus);
  ...
  static class SierpinskiTrianglePane extends Pane {
    ...
    /** Set a new order, if greater than or equal to zero */
