...
public class PExercise28_01 extends Application {
  ...
  public void start(Stage primaryStage) {
    City[] vertices = {new City("Seattle", 75, 50),
      ...
      new City("Houston", 450, 360), new City("Savannah", 500, 350) };
    ...
    int[][] edges = {
      ...
      {11, 8}, {11, 9}, {11, 10}, {12, 7}, {12, 8}, {12, 9}
    };
    ...
    primaryStage.setTitle("PExercise28_01"); // Set the stage title
